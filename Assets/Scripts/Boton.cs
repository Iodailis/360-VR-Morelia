...
namespace VRStandardAssets.Boton
{
	...
	{
		public event Action<Boton> OnButtonSelected;                   // This event is triggered when the selection of the button has finished.
		...
		private IEnumerator ActivateButton()
		{
			...
			Vector3 pos = m_Scene.transform.position;
